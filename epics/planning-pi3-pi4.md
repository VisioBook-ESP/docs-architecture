...
| **SP livrés** | 793 / 1024 (**77%**) |
| **Issues fermées** | 181 / 243 (**74%**) |
| **Heures de dev** | ~317h réalisées |
...
**Total restant itération 3.3** : ~50 SP — ~20h de dev
...
**Total itération 4.1** : ~58 SP — ~23h de dev
...
| infra-helm | (open) | Optimisation perfs (HPA, caching) | 8 | vicous6 |
...
**Total itération 4.2** : ~52 SP — ~21h de dev
...
| Repo | Issue | Titre | SP | Assigné |
|------|-------|-------|:--:|---------|
| infra-helm | (open) | Mise en production (DNS, TLS) | 8 | vicous6 |
| infra-helm | (open) | Monitoring & Alerting (Grafana) | 8 | vicous6 |
...
**Total itération 4.3** : ~40 SP — ~16h de dev
...
| 17/05/2026 | Application complète | ⏳ En cours (77%) |
...
|--------|:-----------------:|:------:|:------------------:|
| **vicous6** | 42 | 17h | ~2.5 semaines |
| **Marinegyt** | 34 | 14h | ~2 semaines |
| **camilogzlez** | 32 | 13h | ~2 semaines |
| **FlorianBernier** | 21 | 8h | ~1 semaine |
| **VictorVattierEpitech** | 13 | 5h | ~1 semaine |
| **Romain-Ber** | 8 | 3h | ~0.5 semaine |

> **Note** : Camserho (content-ingestion 100%) et TasseritNicolas (infra CI 100%) ont terminé leurs tâches. Disponibles en renfort sur les tests E2E ou le monitoring.
...
| Web portal à 31% d'avancement | Retard global | Focus camilogzlez sur phases 3-4 en priorité |
| Charge inégale (Camserho/TasseritNicolas à 0) | Sous-utilisation | Repositionner sur tests E2E ou monitoring |
